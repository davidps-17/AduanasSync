/** Lista completa de países para formularios aduaneros chilenos.
 *  Incluye Chile y todos los países con los que Chile tiene relaciones consulares. */
export const PAISES_MUNDO: string[] = [
  ...
  'República Checa', 'República del Congo', 'República Dominicana', 'Ruanda', 'Rumania', 'Rusia',
...
/** Países latinoamericanos y fronterizos (útiles para tránsito y comercio) */
...
/** Alias para formularios de viajero (países de procedencia) */
export const PAISES_VIAJERO = PAISES_MUNDO;
